...
def load_clf_models():
    ...
    models_dict = {"nn_clf":importlib.resources.path("meetneighbors.predictvfs.models","nn_clf_pytorch_cats_4232025.bin"),
                   "int_clf":importlib.resources.path("meetneighbors.predictvfs.models","meta-LR_4232025.obj")}
    return models_dict
